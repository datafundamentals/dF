...
- `apps/df-firebase-teaching-app0/scripts/seed-data/seed.ts` – numerous `console.log` diagnostics and legacy commented blocks
- `apps/df-firebase-teaching-app0/functions/src/**` – commented code in callable/trigger examples
