...
**File:** `apps/df-chat-tmp-test-app/functions/src/triggers/onTodoCreated.ts`
...
- `apps/df-chat-tmp-test-app/src/df-firestore-demo.ts` - UI integration

**Storage + Firestore Composite:**
- `packages/state/src/stores/storage.store.ts` - File upload patterns
- `apps/df-chat-tmp-test-app/src/df-storage-demo.ts` - Metadata tracking

**Firestore Triggers:**
- `apps/df-chat-tmp-test-app/functions/src/triggers/onTodoCreated.ts`
- `apps/df-chat-tmp-test-app/functions/src/triggers/onTodoUpdated.ts`
- `apps/df-chat-tmp-test-app/functions/src/triggers/onTodoDeleted.ts`
