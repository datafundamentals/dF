...
**Location:** `apps/df-firebase-teaching-app0/functions/src/callable/exchangeGoogleToken.ts`
...
**Location:** `apps/df-firebase-teaching-app0/src/auth-token-exchange.ts`
