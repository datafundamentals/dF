...
**File:** `apps/df-firebase-teaching-app4/functions/src/triggers/onTodoCreated.ts`
...
- `apps/df-firebase-teaching-app4/src/df-firestore-demo.ts` - UI integration

**Storage + Firestore Composite:**
- `packages/state/src/stores/storage.store.ts` - File upload patterns
- `apps/df-firebase-teaching-app4/src/df-storage-demo.ts` - Metadata tracking

**Firestore Triggers:**
- `apps/df-firebase-teaching-app4/functions/src/triggers/onTodoCreated.ts`
- `apps/df-firebase-teaching-app4/functions/src/triggers/onTodoUpdated.ts`
- `apps/df-firebase-teaching-app4/functions/src/triggers/onTodoDeleted.ts`
