...
export class DfFirebaseTeachingApp extends LitElement {
    ...
    return html`
      ...
      <section aria-labelledby="emulator-setup">
        ...
        <ul>
          ...
          <li><code>pnpm --filter @df/df-firebase-teaching-app5 emulators:start</code></li>
          <li><code>pnpm --filter @df/df-firebase-teaching-app5 dev</code></li>
  ...
  private getChecklist(): ChecklistItem[] {
    return [
      ...
      {
        label: 'Run `pnpm --filter @df/df-firebase-teaching-app5 emulators:start`',
        completed: this.emulatorStatus === 'connected',
      },
      {
        label: 'Run `pnpm --filter @df/df-firebase-teaching-app5 dev`',
        completed: false,
      },
    ];
  }
