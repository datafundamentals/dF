# How to Install the DF Markdown Tools Extension
...
1.  **Locate the VSIX file:**
    ...
    `extensions/df-markdown-tools/df-markdown-tools-0.0.1.vsix`
...
3.  **Verify Installation:**
    ...
    - You should see the "DF Tools" icon (book icon) in the editor title bar (top right).
    - Click the icon to open the tools panel.

## Updating the Extension

To update the extension after making changes:
1.  Run `pnpm run pack` in the `extensions/df-markdown-tools` directory to generate a new `.vsix` file.
