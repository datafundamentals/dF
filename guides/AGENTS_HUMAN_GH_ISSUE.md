...
# Copilot suggests: apps/df-firebase-teaching-app/functions/src/callable/
...
- [ ] `apps/df-firebase-teaching-app/` (app-specific)
...
3. **Copilot Chat Session**
   ...
   apps/df-firebase-teaching-app/src/components/?"
   ```
