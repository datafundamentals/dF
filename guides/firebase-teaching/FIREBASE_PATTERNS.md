...
#### What Belongs in `apps/df-firebase-teaching-app1/`
...
```typescript
// ✅ CORRECT - apps/df-firebase-teaching-app1/src/config/firebase.config.ts
...
│     └─ YES → Add to apps/df-firebase-teaching-app1/src/components/
│
...
└─ Is it SEED DATA or TEACHING EXAMPLES?
   └─ YES → packages/firebase-emulator/emulator-data/
            or apps/df-firebase-teaching-app1/scripts/
```
...
**WRONG:**
```typescript
// apps/df-firebase-teaching-app1/src/config/firebase.config.ts
...
**WRONG:**
```typescript
// apps/df-firebase-teaching-app1/src/utils/firebase-init.ts
...
// apps/df-firebase-teaching-app1/src/main.ts
...
5. **Wire it up in teaching app** → Demo the patterns in `apps/df-firebase-teaching-app1/`
...
- `apps/df-firebase-teaching-app1/tests/integration/` - End-to-end flows with emulators
...
3. **Check the Firebase Teaching App** (`apps/df-firebase-teaching-app1/`) for examples
