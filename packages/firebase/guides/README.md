...
- avoid duplicating the higher-level firebase patterns covered in `guides/firebase-teaching/`
...
- `guides/firebase-teaching/` — teaching app usage patterns that demonstrate these helpers
